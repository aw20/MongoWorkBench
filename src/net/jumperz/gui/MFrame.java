...
public class MFrame extends JFrame {
	...
	public MFrame(String appName) {
		...
		try {
			...
			setSize(Integer.parseInt(prop.getProperty("width", default_width)), Integer.parseInt(prop.getProperty("height", default_height)));

			setLocation(Integer.parseInt(prop.getProperty("top", default_top)), Integer.parseInt(prop.getProperty("left", default_left)));
