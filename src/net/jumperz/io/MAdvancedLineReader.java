...
public class MAdvancedLineReader implements MLineReader {
	...
	public String readLine() throws IOException {
		/*
		 * BufferedReader reader = new BufferedReader( new InputStreamReader( bis, MCharset.CS_ISO_8859_1 ) ); String line = reader.readLine(); if( line == null ) { checkLineDelimiter( line ); return null; } else { checkLineDelimiter( line ); return line; }
		 */
	...
	// --------------------------------------------------------------------------------
	private void checkLineDelimiter(String line) throws IOException {
		reset();
		if (line != null) {
			skip(line.length());
		}
