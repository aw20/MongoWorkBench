...
import net.jumperz.app.MMonjaDBCore.action.mj.MEditFieldAction;
...
public class MDocumentEditor extends MAbstractView implements MOutputView {
	private Tree tree;
	...
	private void verifyData() {
		...
		switch (typeIndex) {
			...
			case 4:// List
				try {
					Object o = dataManager.getDB().eval(value, (Object[]) null);
	...
	private void updateDocument() {
		...
		switch (typeIndex) {
			...
			case 3:// String
				...
				break;
			case 4:// List
				newValue = dataManager.getDB().eval(value, (Object[])null);
				break;
			case 5:// Map
				newValue = dataManager.getDB().eval(value, (Object[])null);
				break;
