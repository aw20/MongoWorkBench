...
public class MBitDog implements MCommand {
	...
	// --------------------------------------------------------------------------------
	public MBitDog(String s) throws IOException {
		configFileName = s;
		in = System.in;
		init();
	}
	...
	// --------------------------------------------------------------------------------
	public MBitDog(String s, InputStream i) throws IOException {
		configFileName = s;
		in = i;
		init();
	}
	...
	public void breakCommand() {
		/*
		 * cleanUp( false ); MStreamUtil.closeStream( in );
		 */
	}
