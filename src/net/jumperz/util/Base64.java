 ...
 * 
 * <p>
 * I am placing this code in the Public Domain. Do with it as you will. This software comes with no guarantees or warranties but with plenty of well-wishing instead! Please visit <a href="http://iharder.net/xmlizable">http://iharder.net/xmlizable</a> periodically to check for updates or to contribute improvements.
 * </p>
 * 
...
public class Base64 {
	...
	private final static byte[] ALPHABET = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I', (byte) 'J', (byte) 'K', (byte) 'L', (byte) 'M', (byte) 'N', (byte) 'O', (byte) 'P', (byte) 'Q', (byte) 'R', (byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z', (byte) 'a', (byte) 'b', (byte) 'c',
			(byte) 'd', (byte) 'e', (byte) 'f', (byte) 'g', (byte) 'h', (byte) 'i', (byte) 'j', (byte) 'k', (byte) 'l', (byte) 'm', (byte) 'n', (byte) 'o', (byte) 'p', (byte) 'q', (byte) 'r', (byte) 's', (byte) 't', (byte) 'u', (byte) 'v', (byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5', (byte) '6', (byte) '7', (byte) '8',
			(byte) '9', (byte) '+', (byte) '/' };
	...
	/**
	 * Simple helper method that Base64-encodes a file and returns the encoded string or <tt>null</tt> if there was an error.
	 * 
	 * @param rawfile
	 *          The file to read
	...
	/**
	 * Simple helper method that Base64-decodes a file and returns the decoded data or <tt>null</tt> if there was an error.
	 * 
	 * @param encfile
	 *          The file to read
	...
	/**
	 * Decodes the first four bytes of array <var>fourBytes</var> and returns an array up to three bytes long with the decoded values.
	 * 
	 * @param fourBytes
	...
	/**
	 * Decodes data from Base64 notation and returns it as a string. Equivlaent to calling <code>new String( decode( s ) )</code>
	 * 
	 * @param s
