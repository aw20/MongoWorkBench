...
public class MSystemUtil {
	...
	// --------------------------------------------------------------------------------
	public static void signAWSRequest(MHttpRequest request, String accessKey, String secretAccessKey) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static String getStringToSign(MHttpRequest request) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static Socket connect(List hostList, int port) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static Socket connect(List hostList, List portList) throws IOException {
		IOException ex = null;
		for (int i = 0; i < hostList.size(); ++i) {
			try {
	...
	// --------------------------------------------------------------------------------
	public static Socket connect(String host, int port, int connectTimeOut) throws IOException {
		IOException ex = null;
		Socket socket = null;
	...
	// --------------------------------------------------------------------------------
	public static boolean isJpeg(String fileName) throws IOException {
	...
	// --------------------------------------------------------------------------------
	/*
	 * public static boolean isJpeg2( String fileName ) throws IOException { FileInputStream is = new FileInputStream( fileName ); try { JPEGImageDecoder decoder = JPEGCodec.createJPEGDecoder( is ); BufferedImage image = decoder.decodeAsBufferedImage(); } catch( Exception e ) { e.printStackTrace(); return false; } finally { MStreamUtil.closeStream( is ); } return true; }
	 */
	// --------------------------------------------------------------------------------
	public static String getCommandResult(String[] cmdArray) throws IOException {
	...
	public static List getParametersFromRequest(MHttpRequest request, String charset) {
		...
		for (int i = 0; i < parameterList.size(); ++i) {
			...
			} else if (parameter.getType() == MAbstractParameter.URI || parameter.getType() == MAbstractParameter.BODY) {
	...
	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(List hostOrIpList, String preferIp) throws UnknownHostException {
	...
	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(List hostOrIpList) throws UnknownHostException {
		return toIpList(hostOrIpList, null);
	}

	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(String[] hostOrIpArray, String preferIp) throws UnknownHostException {
	...
	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(String[] hostOrIpArray) throws UnknownHostException {
	...
	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(String hostNameString, String preferIp) throws UnknownHostException {
	...
	// --------------------------------------------------------------------------------
	public static LinkedList toIpList(String hostNameString) throws UnknownHostException {
		// hostNameStringは "www.example.jp" "1.2.3.4" "www.example.jp,www2.example.jp" "1.2.3.4,1.2.3.3" "www.example.jp,1.2.3.4"みたいなケースがありえる
	...
	// --------------------------------------------------------------------------------
	public static MHttpRequest loadHttpRequestFromFile(String fileName, boolean allowGzip) throws IOException {
		if (allowGzip) {
	...
	// --------------------------------------------------------------------------------
	public static MHttpRequest loadHttpRequestFromFile(String fileName) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static MHttpResponse loadHttpResponseFromFile(String fileName) throws IOException {
		BufferedInputStream bin = new BufferedInputStream(new FileInputStream(fileName));
		try {
	...
	public static boolean isTextHttpResponse(MHttpResponse response) {
		...
		String[] typeList = new String[] { "javascript", "text", "css", };
	...
	// --------------------------------------------------------------------------------
	public static void saveHttpDataToFile(MHttpData data, String fileName) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static String getCommandResult(String command) throws IOException {
	...
	public static void shutdown(SSLSocket socket) {
		/*
		 * Object object = socket; String fieldName = "impl"; Field field = null; Class clazz;
		 * 
		 * clazz = Class.forName( "javax.net.ssl.SSLSocket" ); field = clazz.getDeclaredField( fieldName ); field.setAccessible( true ); object = field.get( object );
		 * 
		 * fieldName = "fd";
		 * 
		 * clazz = Class.forName( "java.net.SocketImpl" ); field = clazz.getDeclaredField( fieldName ); field.setAccessible( true ); object = field.get( object );
		 * 
		 * clazz = Class.forName( "java.io.FileDescriptor" ); field = clazz.getDeclaredField( fieldName ); field.setAccessible( true );
		 * 
	...
	// --------------------------------------------------------------------------------
	public static void clearDir(String dirName) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static boolean renameFile(String from, String to, boolean removeDest) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static boolean renameFile(String from, String to) throws IOException {
	...
	// --------------------------------------------------------------------------------
	public static void loadProperties(Properties prop, InputStream in) throws IOException {
		try {
			prop.load(in);
		} finally {
			in.close();
