...
public class MPerspectiveFactory1 implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		topleftFolder.addView(org.aw20.mongoworkbench.eclipse.view.MDBTree.class.getName());

		topcenterFolder.addView(org.aw20.mongoworkbench.eclipse.view.MCommandConsole.class.getName());
		topcenterFolder.addView(org.aw20.mongoworkbench.eclipse.view.MCommandWizardView.class.getName());
		topcenterFolder.addView(org.aw20.mongoworkbench.eclipse.view.MJavaScriptView.class.getName());
